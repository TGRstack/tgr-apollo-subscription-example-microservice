...
module.exports = {
  default    : series.nps('commit.pre', 'commit.zen', 'commit.post'),
  pre  : {
  ...
  post: {
    description: 'Run some stuff post commiting',
    default: 'nps commit.generate.gitInfo',
  },
  generate: {
    gitInfo: 'npx node-git-info'
  },
}